...
setResult('Correct Answer');
  ...
  return (
    ...
    <br/>
<button onClick={HandleDisablingAndCheckAnswering} disabled={state==='true' ||answer==='Answer'} className={state==='true' ||answer==='Answer'?' opacity-50 border border-black ml-3 mt-2 bg-black text-white w-16':' border border-black ml-3 mt-2 bg-black text-white w-16'}>Submit</button>
    <br/>
    <br/>
